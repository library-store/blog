webpackJsonp([1],Array(196).concat([
/* 196 */
...
Component.options.__file = "resources\\assets\\js\\dashboard\\modules\\product\\Edit.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c1a8449a", Component.options)
  } else {
    hotAPI.reload("data-v-c1a8449a", Component.options)
  }
...
exports.default = {
  ...
  created: function created() {
    ...
    this.$http.get('product/' + this.$route.params.id + '/edit?include=category,tags').then(function (response) {
...
var render = function() {
  ...
  return _c(
    "vue-form",
    { attrs: { title: _vm.$t("form.edit_product") } },
    [
      _c(
        "template",
        { slot: "buttons" },
      ...
      _c(
        "template",
        { slot: "content" },
        [_c("product-form", { attrs: { article: _vm.product } })],
        1
      )
    ],
    2
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c1a8449a", module.exports)
  }
}
